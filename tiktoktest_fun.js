...
function qesfun1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of qesfun1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function ans1RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of ans1Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function qesfun2RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of qesfun2Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function ans2RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of ans2Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function qesfun3RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of qesfun3Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
...
function ans3RoutineBegin(snapshot) {
    return async function () {
      ...
      for (const thisComponent of ans3Components)
        if ('status' in thisComponent)
          thisComponent.status = PsychoJS.Status.NOT_STARTED;
      return Scheduler.Event.NEXT;
    }
